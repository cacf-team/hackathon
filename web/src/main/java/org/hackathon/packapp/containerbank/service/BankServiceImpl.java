...
import org.hackathon.packapp.containerbank.repository.CustomerServiceConsumer;
...
public class BankServiceImpl implements BankService {
    ...
    private CustomerServiceConsumer customerRepository;
    private PaymentRepository paymentRepository;

    @Autowired
    public BankServiceImpl(CardRepository cardRepository, AdvisorRepository advisorRepository, CustomerServiceConsumer customerRepository, PaymentRepository paymentRepository) {
